                    ...
                    <div style={{ maxWidth: '500px' }}>
                        ...
                        <div style={{ display: 'flex', gap: '0.5rem', marginTop: '1rem', justifyContent: 'center' }}>
                            <img
                                ...
                                style={{ width: '40px', height: '40px', objectFit: 'cover', borderRadius: '4px', cursor: 'pointer', border: mainImage === `${import.meta.env.BASE_URL}product.png` ? '2px solid var(--color-accent-primary)' : '1px solid rgba(255,255,255,0.2)' }}
                            />
                            {[1, 2, 3, 4, 5].map((num) => (
                                <img
                                    key={num}
